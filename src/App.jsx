...
function App() {
  ...
  const cakeImage = cakeState === "off" ? cakeOff : cakeState === "lit" ? cakeLit : cakeBlown;
      ...
      <AnimatePresence mode="wait">
        {page === "landing" && (
          ...
          >
            ...
            <p className="text-lg md:text-xl mb-8">The world got better 24 years ago. Wanna know why?</p>
            <button
        ...
        {page === "birthday" && (
          <motion.div
            ...
            className="p-6"
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-4">Because it’s your Birthday! 🥳</h1>
            <p className="text-lg md:text-xl mb-8">Happy Birthday, Sir! Wishing you endless smiles and success 🎉</p>
            <button
        ...
        {page === "cake" && (
          ...
          >
            <h1 className="text-4xl font-bold mb-6">
              {cakeState === "blown" ? "🎉 Make a wish and celebrate! 🎉" : "🎂 Your Cake Awaits! 🎂"}
            </h1>

            <div className="my-8 mx-auto w-64 relative">
              <img src={cakeImage} alt="Birthday Cake" className="w-full rounded-lg shadow-lg" />
            </div>
        ...
        {page === "diary" && (
          ...
          >
            ...
            >
              {diaryIndex === diaryPages.length - 1 ? "Now Wishes Time 🎥" : "Next ➡️"}
            </button>
          </motion.div>
        )}
        ...
        {page === "video" && (
          <motion.div
            ...
            className="p-4 max-w-lg bg-white text-gray-900 rounded-xl shadow-lg mx-auto flex flex-col items-center justify-between h-[90vh]"
          >
            <h2 className="text-2xl font-bold mb-4">{videoPages[videoIndex].heading}</h2>
